...
class AttributeCondition(models.Model):
    ...
    attribute_type = models.CharField(max_length=10, choices=[('stock', 'Stock'), ('resonance', 'Resonance')])
...
class EnSkillEffect(models.Model):
    skill = models.ForeignKey(Skill,on_delete=models.CASCADE,related_name="en_skill_coin_effect")
    uptie_level = models.IntegerField(null=True, blank=True)
    name = models.CharField(max_length =100)
    desc = models.TextField()
    keywords = ArrayField(models.CharField(max_length=30),null=True, blank=True,default = list)
...
class EnCoinEffectList(models.Model):
    ...
    id = models.CharField(max_length=50,primary_key=True)
    skill_coin_effect = models.ForeignKey(EnSkillEffect,on_delete=models.CASCADE,related_name="en_coin_effect",null=True,blank=True)
    action_index = models.IntegerField()

class EnCoinEffectDesc(models.Model):
    # id = coineffectlist id * 97
    id = models.CharField(max_length=50,primary_key=True)
    coin = models.ForeignKey(EnCoinEffectList,on_delete=models.CASCADE,related_name="en_coin_desc",null=True,blank=True)
    desc = models.TextField(blank=True,null=True)
    summary = models.TextField(blank=True,null=True)


class SkillData(models.Model):
    skill = models.ForeignKey(Skill, on_delete=models.CASCADE, related_name='skill_data')
...
class CoinList(models.Model):
    skill_data = models.ForeignKey(SkillData, on_delete=models.CASCADE, related_name='coin_list')
...
class Identity(models.Model):
    ...
    associationList = ArrayField(
            models.CharField(max_length=200,blank=True,null=True),
            default=list,null=True,blank=True)
    characterId = models.ForeignKey(Sinner,on_delete=models.CASCADE,null=True,blank=True)
    panicType = models.ForeignKey(PanicType,on_delete=models.CASCADE,null=True,blank=True)
...
class EnIdentityInfo(models.Model):
    ...
    identity = models.ForeignKey(Identity,on_delete=models.CASCADE,related_name="en_info")
    # identity_id_EN
    id = models.CharField(max_length=50, primary_key=True)
...
class EgoSkillData(models.Model):
    ego_skill = models.ForeignKey(EgoSkill, on_delete=models.CASCADE, related_name='ego_skill_data')
    # skill_data id = skill_id_uptie_level
    id = models.CharField(max_length=50,primary_key=True)
    uptie_level = models.IntegerField()
    attribute_type = models.CharField(max_length=50, blank=True, null=True)
...
class EgoCoinList(models.Model):
    ego_skill_data = models.ForeignKey(EgoSkillData, on_delete=models.CASCADE, related_name='EGO_coin_list')
    operator_type = models.CharField(max_length=50)
    scale = models.FloatField(null=True,blank=True)
    action_index = models.IntegerField()
    # id = skill_data id_index of coin
...
class EnEgoSkillEffect(models.Model):
    id = models.CharField(max_length=50,primary_key=True)
    ego_skill = models.ForeignKey(EgoSkill, on_delete=models.CASCADE, related_name='ego_level_list_en')
...
class EnEgoSkillCoinEffect(models.Model):
    id = models.CharField(max_length=50,primary_key=True)
    ego_skill_effect = models.ForeignKey(EnEgoSkillEffect,on_delete=models.CASCADE,null=True,blank=True)
    action_index = models.IntegerField()
...
class EnEgoSkillCoinEffectDesc(models.Model):
    ...
    desc = models.TextField(blank=True,null=True)
    summary = models.TextField(blank=True,null=True)
    ego_skill_coin_effect = models.ForeignKey(EnEgoSkillCoinEffect,on_delete=models.CASCADE,null=True,blank=True)
...
class EnEgoPassive(models.Model):
    id = models.CharField(max_length=50,primary_key=True)
    ego_passive = models.ForeignKey(EgoPassive,on_delete=models.CASCADE,null=True,blank=True)
...
class Ego(models.Model):
    ...
    awakeningSkillId = models.ForeignKey(EgoSkill,on_delete=models.CASCADE,related_name="awakening_ego_skill",null=True,blank=True)
    corrosionSkillId = models.ForeignKey(EgoSkill,on_delete=models.CASCADE,related_name="corrosion_ego_skill",null=True,blank=True)
